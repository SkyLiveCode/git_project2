...
<div class="col-sm-3" style="display: flex;">                                  
  <div id="signatureHide1" class="signatureHide">
    <label for="basic-default-name" style="font-size: 1.05rem; margin-right: 12px;">John Doe</label>
  </div>
  <img src="../../assets/img/signature/signature-icon1.png" style="margin-top: -10px;" id="image1" class="timestamp__image" data-input-id="signatureInput1" data-name="John Doe" alt="Signature Stamp 1">
  <input type="hidden" id="signatureInput1" class="signature-input" data-signature-id="signatureHide1" name="form1_input13" value="<?php echo htmlspecialchars($form1_input13); ?>" placeholder="">
</div>
-->
