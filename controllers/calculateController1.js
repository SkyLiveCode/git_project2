    ...
    io.on('connection', (socket) => {
        ...
        socket.on('calculate', (data) => {
            ...
            socket.emit('calculatedResult', { 
                ...
                radio14: data.radio14,
                radio15: data.radio15,
                radio16: data.radio16,
                radio17: data.radio17,
                radio18: data.radio18,
                infoinput1: data.infoinput1,
                infoinput2: data.infoinput2,
                infoinput3: data.infoinput3,
                infoinput4: data.infoinput4,
                infoinput5: data.infoinput5,
                infoinput6: data.infoinput6,
                infoinput7: data.infoinput7,
                infoinput8: data.infoinput8,
                infoinput9: data.infoinput9,
                infoinput10: data.infoinput10,
                infoinput11: data.infoinput11,
                infoinput12: data.infoinput12,
                infoinput13: data.infoinput13,
                infoinput14: data.infoinput14,
                infoinput15: data.infoinput15,
                infoinput16: data.infoinput16,
                infoinput17: data.infoinput17,
                infoinput18: data.infoinput18,
                infoinput19: data.infoinput19
